...
namespace UI
{
    public class MainMenu : IMenu
    {
        ...
        private void SeeAllMembers()
        {
            ...
            {
                Log.Error("You must be an Admin to do this!");
                return;
            }
        ...
        {
            Console.WriteLine("You are viewing a list of all restaurants\n ---------- \n");
            List<Restaurants> restaurants = _restaurantbl.ViewAllRestaurants();
        ...
        private void SeeAllReviews()
        {
            ...
            Console.WriteLine("You are viewing a list of the reviews\n ---------- \n");
